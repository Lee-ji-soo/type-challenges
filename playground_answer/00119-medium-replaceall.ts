...
// > = From extends ''
//   ? S
//   : S extends `${From}${infer Z}${From}`
//   ? `${To}${ReplaceAll<Z, From, To>}${To}`
//   : S extends `${infer Z}${From}${infer U}`
//   ? `${Z}${To}${ReplaceAll<U, From, To>}`
//   : S extends `${infer Z}${From}${infer U}`
//   ? `${Z}${To}${ReplaceAll<U, From, To>}`
//   : S
...
> = From extends ''
  ? S
  : S extends `${infer R}${From}${infer Z}`
  ? `${R}${To}${ReplaceAll<Z, From, To>}`
  : S
